  ...
  Future<void> _checkCameraPermission() async {
    try {
      ...
      if (status.isGranted) {
        ...
        if (result.isGranted) {
          ...
          setState(() {
            ...
            _errorMessage = 'Kamera izni verilmedi. Lütfen ayarlardan kamera iznini açın.';
          });
        }
        ...
        setState(() {
          _hasPermission = false;
          _isInitializing = false;
          _errorMessage = 'Kamera izni kalıcı olarak reddedilmiş. Lütfen ayarlardan kamera iznini açın.';
        });
      }
    } catch (e) {
      if (kDebugMode) {
      ...
      setState(() {
        _hasPermission = false;
        _isInitializing = false;
        _errorMessage = 'Kamera izni kontrol edilemedi: $e';
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isInitializing
          ...
          : !_hasPermission || cameraController == null
              ? _buildErrorView()
              : Column(
                  children: [
                    Expanded(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _errorMessage ?? 'Kamera izni gerekli',
              style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w500,
                color: Theme.of(context).brightness == Brightness.dark ? Colors.white : Colors.black,

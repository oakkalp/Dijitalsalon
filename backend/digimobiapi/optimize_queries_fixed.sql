-- ✅ VPS Optimizasyonu - SQL Index'leri ve Query Optimizasyonları (MySQL Uyumlu)
-- Bu index'ler sorgu hızını 10-100x artıracak
-- ✅ NOT: Eğer index zaten varsa hata alabilirsiniz, o index'i atlayıp devam edin
...
-- ✅ Not: idx_medyalar_composite zaten yukarıda var (idx_medyalar_story_created aynı sütunları kapsıyor)
